(() => {
  // <stdin>
  (() => {
    var t, n, o, r, l, d, h, f, p, y, w, x, A, M, F, e = Object.assign || function(e2) {
      ...
      try {
        return Array.isArray(t2) ? t2.filter(i) : G(t2) ? [].slice.call(t2).filter(i) : a(t2) ? [t2].filter(i) : typeof t2 == "string" ? [].slice.call(document.querySelectorAll(t2)).filter(i) : [];
      } catch {
...
See: https://github.com/francoischalifour/medium-zoom`);
      ...
      var r2, u2, F2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, p2 = window.Promise || function(t2) {
        function n3() {
        }
        t2(n3, n3);
      }, A2 = function(t2) {
        ...
        Math.abs(g2 - t2) > i2.scrollOffset && setTimeout(l2, 150);
      }, x2 = function(t2) {
        var n3 = t2.key || t2.keyCode;
        (n3 === "Escape" || n3 === "Esc" || n3 === 27) && l2();
      }, b2 = function() {
        var l3, n3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, o3 = n3;
        return n3.background && (u2.style.background = n3.background), n3.container && n3.container instanceof Object && (o3.container = e({}, i2.container, n3.container)), n3.template && (l3 = a(n3.template) ? n3.template : document.querySelector(n3.template), o3.template = l3), i2 = e({}, i2, o3), c2.forEach(function(e2) {
        ...
        var m3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, n3 = m3.target, h3 = function() {
          if (n4 = { width: document.documentElement.clientWidth, height: document.documentElement.clientHeight, left: 0, top: 0, right: 0, bottom: 0 }, s2 = void 0, r3 = void 0, i2.container)
            if (i2.container instanceof Object)
              n4 = e({}, n4, i2.container), s2 = n4.width - n4.left - n4.right - i2.margin * 2, r3 = n4.height - n4.top - n4.bottom - i2.margin * 2;
            else {
              var n4, C3 = a(i2.container) ? i2.container : document.querySelector(i2.container), l3 = C3.getBoundingClientRect(), _3 = l3.width, y3 = l3.height, v3 = l3.left, g3 = l3.top;
              n4 = e({}, n4, { width: _3, height: y3, left: v3, top: g3 });
            }
          var s2 = s2 || n4.width - i2.margin * 2, r3 = r3 || n4.height - i2.margin * 2, c3 = o2.zoomedHd || o2.original, p3 = O(c3) ? s2 : c3.naturalWidth || s2, A3 = O(c3) ? r3 : c3.naturalHeight || r3, d3 = c3.getBoundingClientRect(), b3 = d3.top, j3 = d3.left, m4 = d3.width, h4 = d3.height, w3 = Math.min(p3, s2) / m4, x3 = Math.min(A3, r3) / h4, u3 = Math.min(w3, x3), E2 = (-j3 + (s2 - m4) / 2 + i2.margin + n4.left) / u3, k3 = (-b3 + (r3 - h4) / 2 + i2.margin + n4.top) / u3, f3 = "scale(" + u3 + ") translate3d(" + E2 + "px, " + k3 + "px, 0)";
        ...
        return new p2(function(e2) {
          ...
          o2.original.dispatchEvent(s("medium-zoom:open", { detail: { zoom: r2 } })), g2 = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0, d2 = true, o2.zoomed = Y(o2.original), document.body.appendChild(u2), i2.template && (f3 = a(i2.template) ? i2.template : document.querySelector(i2.template), o2.template = document.createElement("div"), o2.template.appendChild(f3.content.cloneNode(true)), document.body.appendChild(o2.template)), document.body.appendChild(o2.zoomed), window.requestAnimationFrame(function() {
        ...
        return o2.original;
      }, c2 = [], h2 = [], d2 = false, g2 = 0, i2 = F2, o2 = { original: null, zoomed: null, zoomedHd: null, template: null };
      return Object.prototype.toString.call(n2) === "[object Object]" ? i2 = n2 : (n2 || typeof n2 == "string") && f2(n2), i2 = e({ margin: 0, background: "#fff", scrollOffset: 40, container: null, template: null }, i2), u2 = K(i2.background), document.addEventListener("click", A2), document.addEventListener("keyup", x2), document.addEventListener("scroll", w2), window.addEventListener("resize", l2), r2 = { open: v2, close: l2, toggle: m2, update: b2, clone: M2, attach: f2, detach: S2, on: k2, off: C2, getOptions: j2, getImages: y2, getZoomedImage: _2 }, r2;
    };
    function q(e2, t2) {
      t2 === void 0 && (t2 = {});
    ...
    M = ".medium-zoom-overlay{position:fixed;top:0;right:0;bottom:0;left:0;opacity:0;transition:opacity .3s;will-change:opacity}.medium-zoom--opened .medium-zoom-overlay{cursor:pointer;cursor:zoom-out;opacity:1}.medium-zoom-image{cursor:pointer;cursor:zoom-in;transition:transform .3s cubic-bezier(.2,0,.2,1)!important}.medium-zoom-image--hidden{visibility:hidden}.medium-zoom-image--opened{position:relative;cursor:pointer;cursor:zoom-out;will-change:transform}", q(M), x = T, A = true, f = "production", p = false;
    function k(e2 = false) {
      let t2 = [];
    ...
    function b(e2, n2 = 2, s2 = false) {
      ...
      if (document.dispatchEvent(c2), !s2 && (e2 === false && !t.classList.contains("dark") || e2 === true && t.classList.contains("dark")))
        return;
      e2 === false ? (s2 || (Object.assign(document.body.style, { opacity: 0, visibility: "visible" }), C(document.body, 600)), t.classList.remove("dark"), a2 && (console.debug("Setting HLJS theme to light"), o2 && (o2.disabled = false), i2 && (i2.disabled = true)), r2 && (console.debug("Initializing Mermaid with light theme"), s2 ? (window.mermaid.initialize({ startOnLoad: false, theme: "default", securityLevel: "loose" }), k(true)) : location.reload())) : e2 === true && (s2 || (Object.assign(document.body.style, { opacity: 0, visibility: "visible" }), C(document.body, 600)), t.classList.add("dark"), a2 && (console.debug("Setting HLJS theme to dark"), o2 && (o2.disabled = true), i2 && (i2.disabled = false)), r2 && (console.debug("Initializing Mermaid with dark theme"), s2 ? (window.mermaid.initialize({ startOnLoad: false, theme: "dark", securityLevel: "loose" }), k(true)) : location.reload()));
    }
    function V(e2) {
      if (!c())
        return;
    ...
    function m(e2, t2 = 0) {
      if (e2 = typeof e2 == "undefined" || typeof e2 == "object" ? decodeURIComponent(window.location.hash) : e2, $(e2).length) {
        ...
        let n2 = Math.ceil($(e2).offset().top - g());
    ...
    function S() {
      ...
      t2 && (t2._config.offset = g(), e2.data("bs.scrollspy", t2), e2.scrollspy("refresh"));
    }
    function B() {
    ...
    if (window.addEventListener("hashchange", m), $("#navbar-main li.nav-item a.nav-link, .js-scroll").on("click", function(e2) {
      let t2 = this.hash;
      if (this.pathname === window.location.pathname && t2 && $(t2).length && $(".js-widget-page").length > 0) {
        e2.preventDefault();
        let n2 = Math.ceil($(t2).offset().top - g());
      ...
      n.isotope({ itemSelector: ".isotope-item", percentPosition: true, masonry: { columnWidth: ".grid-sizer" }, filter: function() {
        let e3 = $(this), t2 = !l || e3.text().match(l), n2 = !r || e3.is(r);
        return t2 && n2;
      } });
      let e2 = $(".filter-search").keyup(N(function() {
        l = new RegExp(e2.val(), "gi"), n.isotope();
      }));
      $(".pub-filters").on("change", function() {
        let t2 = $(this), e3 = t2[0].getAttribute("data-filter-group");
        if (o[e3] = this.value, r = D(o), n.isotope(), e3 === "pubtype") {
          let e4 = $(this).val();
    ...
    function P() {
      ...
      let s2 = "pubtype";
      o[s2] = t2, r = D(o), n.isotope(), $(".pubtype-select").val(t2);
    }
    function H() {
      if ($("#map").length) {
    ...
    $(document).ready(function() {
      R();
      let { isDarkTheme: n2, themeMode: s2 } = W();
      b(n2, s2, true), A && hljs.initHighlighting();
      ...
      window.location.hash && a2 === 0 && m(decodeURIComponent(window.location.hash), 0);
      ...
      function r2() {
        i2++, i2 === a2 && (console.debug(`All Portfolio Isotope instances loaded.`), window.location.hash && m(decodeURIComponent(window.location.hash), 0));
      }
    ...
    }), h = document.querySelector(".js-set-theme-light"), d = document.querySelector(".js-set-theme-dark"), y = document.querySelector(".js-set-theme-auto"), h && d && y && (h.addEventListener("click", (e2) => {
      e2.preventDefault(), j(0);
    }), d.addEventListener("click", (e2) => {
      e2.preventDefault(), j(1);
    }), y.addEventListener("click", (e2) => {
      e2.preventDefault(), j(2);
    })), F = window.matchMedia("(prefers-color-scheme: dark)"), F.addEventListener("change", (e2) => {
      V(e2);
    }), window.addEventListener("load", v), window.addEventListener("resize", v), window.addEventListener("orientationchange", v), $("body").on("mouseenter mouseleave", ".dropdown", function(e2) {
      ...
      clearTimeout(w), w = setTimeout(S, 200);
    });
  })();
})();
